...
def register_content(error_message="", success_message=""):
    return Div(
        Div(
            Div(error_message, cls="alert alert-danger") if error_message else "",
        ...
        Form(
            ...
            Div(
                I("person", cls="material-symbols-rounded"),
                Input(
                    type="text", placeholder="Username", name="username", cls="form-input",
            ...
            Div(id="username-error", cls="validation-message mb-2"),
